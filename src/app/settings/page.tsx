                    ...
                    <div className="">
                        <div className="">
                            <div
                                ...
                                <div className="bg-red-reset text-white rounded-lg p-3 mx-4"
                ...
                {resetAlert ?
                    <div
                        ...
                        <div className="w-9/12 h-1/4 bg-bg-header text-lg  rounded-lg relative overflow-hidden">
                            <div className=""></div>
                            <p className='w-full h-full text-center flex items-center justify-center text-white'>Вы
                                уверены что хотите полностью
                            ...
                            <div className="absolute w-full text-center bottom-0 h-10 grid grid-cols-2">
                                ...
                                <div className="text-red-reset font-semibold h-full flex items-center justify-center"
                                     onClick={resetApp}>
                                    Да
                                </div>

                                <div className="text-green-reset font-semibold h-full flex items-center justify-center"
